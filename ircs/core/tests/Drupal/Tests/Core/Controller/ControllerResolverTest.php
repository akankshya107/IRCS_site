...
class ControllerResolverTest extends UnitTestCase {
   ...
   * @expectedExceptionMessage Non existing method 'nonExistingMethod' on class '\Drupal\Tests\Core\Controller\MockController'.
   */
  public function testNonExistingControllerWithoutPath() {
    $definition = '\Drupal\Tests\Core\Controller\MockController::nonExistingMethod';
    $this->controllerResolver->getControllerFromDefinition($definition);
  }

  /**
+   * @expectedException \InvalidArgumentException
+   * @expectedExceptionMessage Non existing method 'nonExistingMethod' on class '\Drupal\Tests\Core\Controller\MockController' on path 'hello'.
+   */
  public function testNonExistingControllerWithPath() {
    $definition = '\Drupal\Tests\Core\Controller\MockController::nonExistingMethod';
    $this->controllerResolver->getControllerFromDefinition($definition, 'hello');
  }
